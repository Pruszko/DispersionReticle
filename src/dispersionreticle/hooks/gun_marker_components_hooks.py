...
if isClientWG():
    GUN_MARKERS_PRIORITY += [
        _CONSTANTS.TWIN_GUN_ARCADE_MARKER_NAME,
        _CONSTANTS.TWIN_GUN_SNIPER_MARKER_NAME,
        _CONSTANTS.DEBUG_TWIN_GUN_ARCADE_MARKER_NAME,
        _CONSTANTS.DEBUG_TWIN_GUN_SNIPER_MARKER_NAME,
        _CONSTANTS.ACCURACY_GUN_ARCADE_MARKER_NAME,
        _CONSTANTS.ACCURACY_GUN_SNIPER_MARKER_NAME,
        _CONSTANTS.DEBUG_ACCURACY_GUN_ARCADE_MARKER_NAME,
        _CONSTANTS.DEBUG_ACCURACY_GUN_SNIPER_MARKER_NAME,
        _CONSTANTS.CHARGE_GUN_ARCADE_MARKER_NAME,
        _CONSTANTS.CHARGE_GUN_SNIPER_MARKER_NAME,
        _CONSTANTS.DEBUG_CHARGE_GUN_ARCADE_MARKER_NAME,
        _CONSTANTS.DEBUG_CHARGE_GUN_SNIPER_MARKER_NAME,
        _CONSTANTS.LOW_CHARGE_SHOT_GUN_ARCADE_MARKER_NAME,
        _CONSTANTS.LOW_CHARGE_SHOT_GUN_SNIPER_MARKER_NAME,
        _CONSTANTS.DEBUG_LOW_CHARGE_SHOT_GUN_ARCADE_MARKER_NAME,
        _CONSTANTS.DEBUG_LOW_CHARGE_SHOT_GUN_SNIPER_MARKER_NAME,
        _CONSTANTS.AUXILIARY_ROCKET_LAUNCHER_GUN_ARCADE_MARKER_NAME,
        _CONSTANTS.AUXILIARY_ROCKET_LAUNCHER_GUN_SNIPER_MARKER_NAME,
        _CONSTANTS.DEBUG_AUXILIARY_ROCKET_LAUNCHER_GUN_ARCADE_MARKER_NAME,
        _CONSTANTS.DEBUG_AUXILIARY_ROCKET_LAUNCHER_GUN_SNIPER_MARKER_NAME,
    ]
